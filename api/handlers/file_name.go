...
// FileNameHandler provides direct, high-speed access to S3 objects via their file path.
...
func FileNameHandler(database *db.DB, signer *aws.CFSigner) gin.HandlerFunc {
