...
func TestValidatePublicStoreKey(t *testing.T) {
	cases := []struct {
		...
		{"archives audio", "archives/audio/sermons/a-sermon.ogg", "archives/audio/sermons/a-sermon.ogg", false},
		{"archives video", "archives/video/programs/a-program.mp4", "archives/video/programs/a-program.mp4", false},
		{"bare prefix rejected", "offline/", "", true},
		{"bare archives prefix rejected", "archives/", "", true},
		{"archives lookalike rejected", "archives-evil/x", "", true},
